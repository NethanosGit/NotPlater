...
local fontBorders = { [""] = L["None"], ["OUTLINE"] = L["Outline"], ["THICKOUTLINE"] = L["Thick Outline"], ["MONOCHROME"] =
L["Monochrome"] }
local anchors = { ["CENTER"] = L["Center"], ["BOTTOM"] = L["Bottom"], ["TOP"] = L["Top"], ["LEFT"] = L["Left"], ["RIGHT"] =
L["Right"], ["BOTTOMLEFT"] = L["Bottom Left"], ["TOPRIGHT"] = L["Top Right"], ["BOTTOMRIGHT"] = L["Bottom Right"],
    ["TOPLEFT"] = L["Top Left"] }
local frameStratas = { ["BACKGROUND"] = L["Background"], ["LOW"] = L["Low"], ["MEDIUM"] = L["Medium"], ["HIGH"] = L
["High"], ["DIALOG"] = L["Dialog"], ["FULLSCREEN"] = L["Fullscreen"], ["FULLSCREEN_DIALOG"] = L["Fullscreen Dialog"],
    ["TOOLTIP"] = L["Tooltip"] }
local drawLayers = { ["BACKGROUND"] = L["Background"], ["BORDER"] = L["Border"], ["ARTWORK"] = L["Artwork"], ["OVERLAY"] =
L["Overlay"], ["HIGHLIGHT"] = L["Highlight"] }
...
function ConfigPrototypes:LoadConfigPrototypes()
                ...
                moveControls = {
                    ...
                    args = {
                        moveUp = {
                            ...
                            type = "execute",
                            name = L["Move Up"],
                            image = NotPlater.isWrathClient and "Interface\\Buttons\\UI-ScrollBar-ScrollUpButton-Up" or
                            nil,
                        ...
                        moveDown = {
                            ...
                            type = "execute",
                            name = L["Move Down"],
                            image = NotPlater.isWrathClient and "Interface\\Buttons\\UI-ScrollBar-ScrollDownButton-Up" or
                            nil,
                            imageWidth = NotPlater.isWrathClient and 32 or nil,
                            imageHeight = NotPlater.isWrathClient and 32 or nil,
                            func = function()
    ...
    ConfigPrototypes.ThreatNameplateColors = {
        ...
        colors = ConfigPrototypes:GetGeneralisedThreatColorsConfig(L["Aggro on You"], L["Tank no Aggro"], L["DPS Close"],
            L["Aggro on You"], L["High Threat"], L["No Aggro"], L["Other Tank Aggro"])
    }
    ConfigPrototypes.ThreatNumberText = ConfigPrototypes:GetGeneralisedThreatFontConfig(L["Number 1 in Group"],
        L["Above 80% in Group"], L["Below 80% in Group"], L["Number 1 in Group"], L["Above 80% in Group"],
        L["Below 80% in Group"])
    ConfigPrototypes.ThreatDifferentialText = ConfigPrototypes:GetGeneralisedThreatFontConfig(L["Aggro on You"],
        L["Tank no Aggro"], L["DPS Close"], L["Aggro on You"], L["High Threat"], L["No Aggro"])
    ...
    ConfigPrototypes.ThreatPercentStatusBar.colors = ConfigPrototypes:GetGeneralisedThreatColorsConfig(L["100%"],
        L["Above 90%"], L["Below 90%"], L["100%"], L["Above 90%"], L["Below 90%"])
    ...
    ConfigPrototypes.ThreatPercentText.colors = ConfigPrototypes:GetGeneralisedThreatColorsConfig(L["100%"],
        L["Above 90%"], L["Below 90%"], L["100%"], L["Above 90%"], L["Below 90%"])
    ...
    ConfigPrototypes.HealthText.general.args.displayType = {
        ...
        type = "select",
        name = L["Display Type"],
        values = { ["none"] = L["None"], ["current"] = L["Current"], ["minmax"] = L["Current / Max"], ["minmaxpercent"] = L["Current / Max"] .. " / " .. L["Percent"], ["both"] = L["Current"] .. " / " .. L["Percent"], ["percent"] = L["Percent"] },
    }
...
function ConfigPrototypes:BuildBuffsArgs(api)
    ...
    local function CreateAuraFrameGroup(order, frameKey, label, opts)
        ...
        local groupArgs = {
            ...
            borderThickness = FrameDimension(frameKey, "borderThickness", 12, L["Border Thickness"], 0, 5, 0.1, 1,
                disabled),
    ...
    return {
        general = {
            ...
            args = {
                ...
                enableCombatLogTracking = {
                    ...
                    desc = L
                    ["Learns aura durations from the combat log so timers persist after you stop targeting a unit. Timers may be inaccurate until the addon has seen an aura at least twice."],
                },
            },
        },
        frames = {
        ...
        tracking = {
            ...
            args = {
                ...
                blacklistDebuffs = BuildAuraListGroup(2, "blacklistDebuffs", L["Debuff Blacklist"],
                    L["Add Debuff by Name"], L["Add Debuff by ID"], api),
                blacklistBuffs = BuildAuraListGroup(3, "blacklistBuffs", L["Buff Blacklist"], L["Add Buff by Name"],
                    L["Add Buff by ID"], api),
                extraDebuffs = BuildAuraListGroup(4, "extraDebuffs", L["Extra Debuffs"], L["Add Debuff by Name"],
                    L["Add Debuff by ID"], api),
                extraBuffs = BuildAuraListGroup(5, "extraBuffs", L["Extra Buffs"], L["Add Buff by Name"],
                    L["Add Buff by ID"], api),
            },
        },
    }
